<?php
/**
 * Plugin Name: Simple Sticky Buy Now For WooCommerce 
 * Plugin URI: https://solbox.dev/plugins/sticky-cart/?utm_source=freemium&utm_medium=author-uri&utm_campaign=go_pro
 * Description: Simple Sticky Buy Now For WooCommerce use to show sticky add to cart on product page. Its helps to grab more sale rather than boring WooCommerce add to cart button. It support ajax add to cart, color customization according to theme, variable product sticky cart and much more.
 * Version: 1.0.0
 * Author: Geek Tech
...
define( 'WSATC_PRO_LINK', 'https://codecanyon.net/' );
define( 'WSATC_BLACK_FRIDAY', '2021-12-15' );
