...
function wsatc_woo_require_notice() {
	...
	echo "<div class='error notice-info is-dismissible'>
					<p><strong>Simple Sticky Buy Now For WooCommerce </strong> requires WooCommerce Active & Install <a href='$plugin_install'>Click here</a> to Install.</p> 
			 </div>";
}
...
function wsatc_activate_path() {
	return 'sticky-buy-now-woo/woo-sticky-add-to-cart.php';
}
