 ...
 * @package    Wsatc
 * @subpackage Wsatc/includes
 * @author     Geek Tech <geekstechgroup@gmail.com>
 */
class Wsatc {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wsatc-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wsatc-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wsatc-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-wsatc-public.php';

		/**
		 * Helper function for plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'lib/solbox-plugin-deactivation-survey/deactivate-feedback-form.php';
