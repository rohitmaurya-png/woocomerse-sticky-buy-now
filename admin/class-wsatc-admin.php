...
class Wsatc_Admin {
	...
	public function render_setting_page() {
		echo sprintf( '<h1>%1$s</h1>', __( 'Simple Sticky Buy Now For WooCommerce', 'woo-sticky-add-to-cart' ) );
	...
	public function render_analytics_page() {
		echo sprintf( '<h1 class="wstac-header">%1$s</h1>', __( 'Simple Sticky Buy Now For WooCommerce', 'woo-sticky-add-to-cart' ) );
	...
	public function is_pro_setting() {
		if ( ! class_exists( 'Wsatc_Pro' ) ) {
				echo sprintf( "<a class='pro-badge' href='" . WSATC_PRO_LINK . "'>%s</a>", __( 'Coming Soon', 'woo-sticky-add-to-cart' ) );
		}
	}
	...
	public function plugin_row_meta( $meta_fields, $file ) {
		...
		$plugin_rate   = 'https://wordpress.org/support/plugin/sticky-buy-now-woo/reviews/?rate=5#new-post';
		$plugin_filter = 'https://wordpress.org/support/plugin/sticky-buy-now-woo/reviews/?filter=5';
	...
	public function black_friday_notice(){
		...
		echo "<div class='notice notice-info'>
			<p><strong>Simple Sticky Buy Now For WooCommerce </strong> represent <strong>Black Friday & Cyber Monday</strong>🔥 MASSIVE savings -30% OFF on all plans. Use 
